...
*/
export const EncryptedExamScoreABI = {
  "abi": [
    {
      "inputs": [],
      ...
      "outputs": [
        {
          ...
          "internalType": "struct EncryptedExamScore.AuditLog[]",
          "name": "filteredLogs",
          "type": "tuple[]"
        }
      ],
    ...
    },
    {
      ...
      "name": "getEmergencyApprovalCount",
      "outputs": [
        {
          "internalType": "uint256",
          "name": "",
